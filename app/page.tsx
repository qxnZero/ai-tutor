        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Generate personalized courses on any topic with our AI tutor. From
              programming to photography, create your own learning path in
              seconds.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-muted/50 rounded-lg p-6">
            ...
            <p className="text-muted-foreground">
              Courses tailored to your specific needs, interests, and skill
              level.
            </p>
          </div>
          <div className="bg-muted/50 rounded-lg p-6">
            ...
            <p className="text-muted-foreground">
              Get help from our AI tutor that answers questions about your
              lessons.
            </p>
          </div>
          <div className="bg-muted/50 rounded-lg p-6">
            ...
            <p className="text-muted-foreground">
              Test your knowledge with AI-generated quizzes and practice
              activities.
            </p>
          </div>
        </div>

        <div id="generate-course" className="scroll-mt-24">
